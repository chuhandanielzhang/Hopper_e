...
class MuJoCoInterface:
    ...
    def get_state(self):
        ...
        # 相对速度：v_rel = v_foot - v_base - ω×r
        base_vel_world = body_vel_world
        omega_world = body_ang_vel_world
        r_world = foot_pos_rel
        foot_vel_world_rel = foot_vel_world_abs - base_vel_world - np.cross(omega_world, r_world)
